...
<div class="container">
    ...
    <div class="row mt40" style="padding-top: 20px">
        ...
        <table class="table table-bordered">
            ...
            if($tia==5){
                $sq="select * from All_Information where Cancer_Classified like '%$tib%'  order by DRACP_ID asc";
            }
            if($tia==6){
                if($tib=='Literature'){
            ...
            if($tia==5){
                $sqld="select * from All_Information where Cancer_Classified like '%$tib%'  order by DRACP_ID asc limit $start,$pagesize";
            }
            if($tia==6){
                if($tib=='Literature'){
            ...
            while($row=mysqli_fetch_assoc($rsd)) {
                ...
                echo ' <tr>
                <td><a href="CB_content.php?id='.$row['DRACP_ID'].'" >'.$row['DRACP_ID'].'</a></td>
