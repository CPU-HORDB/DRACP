    ...
    <div class="row mt40" style="padding-top: 20px">
        ...
        <table class="table table-bordered">
            ...
            while($row=mysqli_fetch_assoc($rsd)) {
                ...
                echo ' <tr>
                <td><a href="Peptide_content.php?id='.$row['DRACP_ID'].'" >'.$row['DRACP_ID'].'</a></td>
...
<div class="container mt-5">
    ...
    <div class="text-right mb-5">
        ...
        echo ' <a href="Peptide_Information.php?page=1" class="btn btn-default">First</a> ';
        ...
        if($pagecount>$showpages){
            ...
            for($i=$start;$i<=$end;$i++){
                if($i==$page){
                    echo ' <a href="Peptide_Information.php?page='.$i.'" class="btn btn-primary">'.$i.'</a> ';
                }else{
                    echo ' <a href="Peptide_Information.php?page='.$i.'" class="btn btn-default" >'.$i.'</a> ';
                }
            }
        }else{
            for($i=$start;$i<=$end;$i++) {
        ...
        echo ' <a href="Peptide_Information.php?page='.$pagecount.'" class="btn btn-default">Last</a> ';
