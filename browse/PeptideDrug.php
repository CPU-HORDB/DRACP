...
<div class="container">
    ...
    <div class="row mt40" style="padding-top: 20px">
        ...
        <table class="table table-bordered">
            ...
            $sq="select * from peptidedrug    order by BAPD_ID asc";
            ...
            $sqld="select * from peptidedrug    order by BAPD_ID asc limit $start,$pagesize";
            ...
            while($row=mysqli_fetch_assoc($rsd)) {
                ...
                echo ' <tr>
                <td><a href="content.php?id='.$row['BAPD_ID'].'" >'.$row['BAPD_ID'].'</a></td>
...
<div class="container mt-5">
    ...
    <div class="text-right mb-5">
        ...
        <?php
        echo ' <a href="PeptideDrug.php?page=1&slt='.$tit.'&txtarea='.$tcont.'" class="btn btn-default">First</a> ';
        ...
        if($pagecount>$showpages){
            ...
            for($i=$start;$i<=$end;$i++){
                if($i==$page){
                    echo ' <a href="PeptideDrug.php?page='.$i.'&slt='.$tit.'&txtarea='.$tcont.'" class="btn btn-primary">'.$i.'</a> ';
                }else{
                    echo ' <a href="PeptideDrug.php?page='.$i.'&slt='.$tit.'&txtarea='.$tcont.'" class="btn btn-default" >'.$i.'</a> ';
                }
            }
        }else{
            for($i=$start;$i<=$end;$i++) {
        ...
        echo ' <a href="PeptideDrug.php?page='.$pagecount.'&slt='.$tit.'&txtarea='.$tcont.'" class="btn btn-default">Last</a> ';
        ?>
