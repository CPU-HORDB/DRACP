...
$sql="select * from peptidedrug where BAPD_ID='$tit'";
...
<div class="container" style="padding-top: 0.3%">
    <div class="row">
        <ol class="breadcrumb">
    ...
    <div style="padding: 12px;background-color: #f7f7f7;border: 1px solid #ddd;border-radius: 12px;">
        ...
        <p>
            <span style="color: #3a95c8;font-weight: bold">BAPD ID</span>&nbsp; <?php echo $row['BAPD_ID']?>
        </p>
        <p>
            <span style="color: #3a95c8;font-weight: bold">Active Ingredients</span>&nbsp;&nbsp; <?php echo $row['Active_Ingredients']?>
        </p>
        <p>
            <span style="color: #3a95c8;font-weight: bold">PubChem CID</span>&nbsp; <?php echo $row['PubChem_CID']?>
        </p>
        <p>
            <span style="color: #3a95c8;font-weight: bold">DRUGBANK Accession Number</span>&nbsp; <?php echo $row['DRUGBANK_Accession_Number']?>
        </p>
        <p>
            <span style="color: #3a95c8;font-weight: bold">Synonyms</span>&nbsp; <?php echo $row['Synonyms']?>
        </p>
        <p>
            <span style="color: #3a95c8;font-weight: bold">Active Sequence</span>&nbsp; <?php echo $row['Active_Sequence']?>
        </p>
        <p>
            <span style="color: #3a95c8;font-weight: bold">Sequence Length</span>&nbsp; <?php echo $row['Sequence_Length']?>
        </p>
        <p>
            <span style="color: #3a95c8;font-weight: bold">Molecular Formula</span>&nbsp; <?php echo $row['Molecular_Formula']?>
        </p>
        <p>
            <span style="color: #3a95c8;font-weight: bold">Molecular Weight</span>&nbsp; <?php echo $row['Molecular_Weight']?>
        </p>
        <p>
            <span style="color: #3a95c8;font-weight: bold">IUPAC Name</span>&nbsp; <?php echo $row['IUPAC_Name']?>
        </p>
        <p>
        ...
        <p>
            <span style="color: #3a95c8;font-weight: bold">Description</span>&nbsp; <?php echo $row['Description']?>
        </p>
        <p>
            <span style="color: #3a95c8;font-weight: bold">UNII</span>&nbsp; <?php echo $row['UNII']?>
        </p>
        <p>
            <span style="color: #3a95c8;font-weight: bold">CAS</span>&nbsp; <?php echo $row['CAS']?>
        </p>
        <p>
            <span style="color: #3a95c8;font-weight: bold;word-break:break-all">InChI</span>&nbsp;
            <span style="word-break:break-all"><?php echo $row['InChI']?></span>
        </p>
        <p>
            <span style="color: #3a95c8;font-weight: bold;word-break:break-all">InChI_Key</span>&nbsp;
            <span style="word-break:break-all"><?php echo $row['InChI_Key']?></span>
        </p>
        <p>
            <span style="color: #3a95c8;font-weight: bold;word-break:break-all">SMILES</span>&nbsp;
    ...
    <table class="table table-bordered"  style="padding: 12px;background-color: #f7f7f7;border: 1px solid #ddd;border-radius: 12px;">
        ...
        <tr>
            ...
            <th style="color: #3a95c8;font-weight: bold">Drug Name</th>
            <th style="color: #3a95c8;font-weight: bold">Strength</th>
            <th style="color: #3a95c8;font-weight: bold">Dosage Form/Route</th>
            <th style="color: #3a95c8;font-weight: bold">Company</th>
            <th style="color: #3a95c8;font-weight: bold">Marketing Status</th>
            <th style="color: #3a95c8;font-weight: bold">Drug ID</th>
            <th style="color: #3a95c8;font-weight: bold">Approval year</th>
        ...
        $sqlde="select * from marketpeptide  where  BAPD_ID='$tit'  order by BAPD_ID asc ";
